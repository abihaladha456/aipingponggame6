...
var ball = {
  ...
  if (leftWrist) {
    ...
    ellipse(leftWrist.x, leftWrist.y, 20); // Draw a red dot at the left wrist position
  
}

function preload(){
  ball_touch_paddle=loadSound("ball-touch-paddle.wav");
...
// Function to reset the game state to its initial settings
function draw(){
